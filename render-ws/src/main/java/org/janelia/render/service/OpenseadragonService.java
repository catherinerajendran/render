...
public class OpenseadragonService {
    ...
    public String getTestService(@FormParam("clustername") final String clustername,
        ...
        try {
            ...
            System.out.println("****** OpenseaDragonService Start ******");
            System.out.println(data_prep);
            System.out.println(data_prepsh);
            System.out.println(openseadragonDataDestinationFolder);
            System.out.println(openseadragonDataHost);
            System.out.println(openseadragonDataSourceFolder);
            System.out.println(renderHost);
            System.out.println("****** OpenseaDragonService End ******");
            ...
            channelExec.setCommand("bsub -P test -R 'rusage[mem=6000]' -q standard 'python3 "+data_prep+" "+stackowner+" "+stackproject+" "+stack+" "
                    +data_prep+" "+data_prepsh+" "+openseadragonDataDestinationFolder+" "+openseadragonDataHost+" "+openseadragonDataSourceFolder+" "
                    +renderHost+"'");
                    //" "+"bioimg-wkst10.stjude.sjcrh.local:8080"+"'");
            channelExec.connect();
